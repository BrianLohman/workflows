...
process extract {
  ...
  script:
    """
    bcftools view /scratch/ucgd/lustre/work/u0806040/data/vcf_files/P231_hg38.bcf -R $bed -O v -o ${bed.baseName}_pathway.vcf
    """
}
...
process gnomad {
  ...
  output:
    file("${pathway_vep_vcf.baseName}_gnomad.vcf") into pathway_vep_sorted_gnomad_vcf_files
 
  script:
    """
    vcfanno -p 6 /scratch/ucgd/lustre/work/u0806040/data/gnomAD_hg38.conf $pathway_vep_vcf > ${pathway_vep_vcf.baseName}_gnomad.vcf
    """
}
